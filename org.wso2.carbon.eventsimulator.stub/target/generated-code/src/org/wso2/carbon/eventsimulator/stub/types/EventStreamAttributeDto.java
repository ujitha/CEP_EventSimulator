            ...
            try {
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"EventStreamAttributeDto".equals(type)){
                                ...
                                return (EventStreamAttributeDto)org.wso2.carbon.eventsimulator.stub.types.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
                ...
                java.util.Vector handledAttributes = new java.util.Vector();
                    ...
                    reader.next();
                                    ...
                                    if (reader.isStartElement() && new javax.xml.namespace.QName("http://admin.eventsimulator.carbon.wso2.org/xsd","attributeType").equals(reader.getName())){
