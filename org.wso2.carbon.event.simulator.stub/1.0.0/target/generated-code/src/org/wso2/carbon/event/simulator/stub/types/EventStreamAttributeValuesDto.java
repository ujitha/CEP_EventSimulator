...
/**
 * EventStreamAttributeValuesDto.java
 *
 ...
 */
            ...
            /**
            *  EventStreamAttributeValuesDto bean class
            */
        ...
        /* This type was generated from the piece of schema that had
                name = EventStreamAttributeValuesDto
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":EventStreamAttributeValuesDto",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "EventStreamAttributeValuesDto",
                           xmlWriter);
                   }
    ...
    public static class Factory{
        ...
        */
        public static EventStreamAttributeValuesDto parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            EventStreamAttributeValuesDto object =
                new EventStreamAttributeValuesDto();
            ...
            try {
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"EventStreamAttributeValuesDto".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (EventStreamAttributeValuesDto)org.wso2.carbon.event.simulator.stub.types.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
                ...
                java.util.Vector handledAttributes = new java.util.Vector();
                    ...
                    reader.next();
                                    ...
                                    if (reader.isStartElement() && new javax.xml.namespace.QName("http://admin.simulator.event.carbon.wso2.org/xsd","attributeName").equals(reader.getName())){
                                    ...
                                    if (reader.isStartElement() && new javax.xml.namespace.QName("http://admin.simulator.event.carbon.wso2.org/xsd","type").equals(reader.getName())){
                                    ...
                                    if (reader.isStartElement() && new javax.xml.namespace.QName("http://admin.simulator.event.carbon.wso2.org/xsd","value").equals(reader.getName())){
